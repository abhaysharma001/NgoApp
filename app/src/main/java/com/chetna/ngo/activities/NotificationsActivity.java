...
import com.chetna.ngo.databinding.ActivityNotificationsBinding;
...
public class NotificationsActivity extends AppCompatActivity {
    ...
    private void getNotificationList() {
        Log.e("TAG", "getNotifications: " + Constants.getString(context, Constants.USER_TYPE));
        Constants.showProgressDialog(" Loading Notifications!", "Please Wait...", context);
        StringRequest request = new StringRequest(Request.Method.POST, BaseUrls.GET_NOTIFICATIONS, response -> {
